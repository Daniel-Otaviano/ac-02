...
'''
def insere_na_pilha(x,numero):
    topo = x.append(numero)
...
def balanceada(string):
    ...
    for letra in string:
            if (letra == '(' or letra == '[' or letra =='{'):
                insere_na_pilha(x, letra)
            elif ((letra == ')' or letra == ']' or letra == '}') and (len(x) == 0)):
                return False
            elif ((letra == ')' or letra == ']' or letra == '}') and (len(x) > 0)):
                if (encaixa(x[len(x) - 1], letra)):
                    remove_do_topo(x)
                else:
                    return False
    return True
...
def balanceada(string):
    ...
    for letra in string:
        if(letra == '(' or letra == '[' or letra == '{' or letra == '<'):
            insere_na_pilha(x, letra)
            c = c + 1
            insere_na_pilha(tamanho, c)
           

        if((letra == ')' or letra == ']' or letra == '}' or letra == '>') and (len(x) == 0)):
        ...
        if((letra == ')' or letra == ']' or letra == '}' or letra == '>') and (len(x) > 0)):
            ...
            if(encaixa(x[len(x) - 1], letra)):
                ...
                return False
        if(not (letra == '(' or letra == '[' or letra == '{' or letra == '<' or letra == ')' or letra == ']' or letra == '}' or letra == '>')):
            continue
...
def palindromo(string):
    ...
    for i in range(0, pilha_length):
        pop = remove_do_topo(x)
        string_inversa = string_inversa + pop
